                    ...
                    <div class="col-md-12">
                      <div class="mu-latest-course-single">
                        <figure class="mu-latest-course-img">
                         <a href="cursoSu.php"><img src="assets/img/courses/44.png" alt="img"></a>
                        ...
                        <div class="mu-latest-course-single-content">
                          <h2><a href="cursoSu.php">Salesforce crm.</a></h2>
                          <h4>Recomendado para empezar</h4>
                          <ul>
                            <li> <span>Precio del curso</span> <span>Gratis</span></li>
                            <li> <span>Course Duration</span> <span>13 hours</span></li>
                          </ul>
                    ...
                    <div id="mu-related-item-slide">
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          ...
                          <div class="mu-latest-course-single-content">
                            <h4><a href="#">crm practico con con interface facil de entender.</p>
                            <div class="mu-latest-course-single-contbottom">
                              <a href="#" class="mu-course-details">Duracion</a>
                              <span href="#" class="mu-course-price">10 hours</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          ...
                          <div class="mu-latest-course-single-content">
                            <h4><a href="#">crm que se controla mediante el lenguaje de programacion ruby.</a></h4>
                            <p></p>
                            <div class="mu-latest-course-single-contbottom">
                              <a href="#" class="mu-course-details">Duracion</a>
                              <span href="#" class="mu-course-price">9 hours</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          ...
                          <div class="mu-latest-course-single-content">
                            <h4><a href="#">crm de paga pero probablemete con muy buena calidad y disponible en movil</a></h4>
                            <p></p>
                            <div class="mu-latest-course-single-contbottom">
